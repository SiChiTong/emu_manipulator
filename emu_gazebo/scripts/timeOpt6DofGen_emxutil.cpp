...
static void emxCopyMatrix_real_T1(double dst[6], const double src[6]);
static void emxCopyMatrix_real_T2(double dst[12], const double src[12]);
static void emxCopyStruct_cell_1(cell_1 *dst, const cell_1 *src);
...
static void emxFreeStruct_cell_1(cell_1 *pStruct);
static void emxInitStruct_cell_1(cell_1 *pStruct);
...
static void c_emxCopyStruct_coder_internal_(c_coder_internal_anonymous_func *dst,
  const c_coder_internal_anonymous_func *src)
{
  emxCopyStruct_cell_1(&dst->tunableEnvironment, &src->tunableEnvironment);
}
...
static void d_emxFreeStruct_coder_internal_(c_coder_internal_anonymous_func
  *pStruct)
{
  emxFreeStruct_cell_1(&pStruct->tunableEnvironment);
}
...
static void d_emxInitStruct_coder_internal_(c_coder_internal_anonymous_func
  *pStruct)
{
  emxInitStruct_cell_1(&pStruct->tunableEnvironment);
}
...
static void emxCopyStruct_cell_1(cell_1 *dst, const cell_1 *src)
{
  ...
  emxCopyMatrix_real_T1(dst->f3, src->f3);
  emxCopyMatrix_real_T1(dst->f4, src->f4);
  dst->f5 = src->f5;
}
...
void emxCopyStruct_struct_T(d_struct_T *dst, const d_struct_T *src)
{
  ...
  dst->f_1 = src->f_1;
  emxCopyMatrix_real_T2(dst->cIneq_1, src->cIneq_1);
  emxCopy_real_T(&dst->cEq_1, &src->cEq_1);
  dst->f_2 = src->f_2;
  emxCopyMatrix_real_T2(dst->cIneq_2, src->cIneq_2);
...
void emxCopyStruct_struct_T1(e_struct_T *dst, const e_struct_T *src)
{
  ...
  emxCopyMatrix_real_T2(dst->cIneq, src->cIneq);
  emxCopyMatrix_real_T2(dst->cIneq_old, src->cIneq_old);
...
void emxCopyStruct_struct_T2(h_struct_T *dst, const h_struct_T *src)
{
  ...
  emxCopyMatrix_real_T2(dst->bineq, src->bineq);
